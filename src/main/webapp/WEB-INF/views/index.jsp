        ...
        <div class="container">
          ...
          <div class="menu left">
            ...
            <div class="registration flex-center">
              <div class="join-us">
                <!-- Join Us Button -->
                <li class="pointer animate"><a onclick="window.open('register','login_popup','width=900,height=1000,location=no,status=no,scrollbars=yes')">회원가입</a></li>
              </div>
              <div class="getting-started">
                <!-- Get Started Button -->
                <li class="main-btn pointer text-center animate"><a onclick="window.open('login','login_popup','width=900,height=1000,location=no,status=no,scrollbars=yes')">로그인</a></li>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-12 col-md-7">
            <div class="add-image add1">
              ...
              <div class="add-image-info flex-center">
                <img src="images/pointer.svg" class="left" alt="">
                <!-- image location -->
                <p>Melbourne,Australia</p>
              </div>
            </div>
